...
module.exports = {
  db       : process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/timetable',
  optaplannerService : {
    hostname : 'timetablesolverservice-kollavarsham.rhcloud.com',
    port : 80,
    basepath : ''
  },
  assets   : {
